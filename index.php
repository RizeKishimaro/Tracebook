        ...
        <div class="">
          <div class=" d-flex flex-column">
            ...
            <div class=" p-1 text-break pb-2">
              <div class="">
                <a href="#" class=" text-decoration-none page-icon-fade about-bar-fs-sm">Privacy &diams;</a>
                <a href="#" class=" text-decoration-none page-icon-fade about-bar-fs-sm">Terms &diams;</a>
                <a href="#" class=" text-decoration-none page-icon-fade about-bar-fs-sm">Advertising &diams;</a>
                <a href="#" class=" text-decoration-none page-icon-fade about-bar-fs-sm">Ad choice &diams;</a>
                <a href="#" class=" text-decoration-none page-icon-fade about-bar-fs-sm">Cookies &diams;</a>
                <a href="#" class=" text-decoration-none page-icon-fade about-bar-fs-sm">More &diams;</a>
